...
class virDomain(object):
    ...
    def coreDumpWithFormat(self, to, dumpformat, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainCoreDumpWithFormat() failed', dom=self)
        return ret
    ...
    def delIOThread(self, iothread_id, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainDelIOThread() failed', dom=self)
        return ret
    ...
    def fsInfo(self, flags=0):
        ...
        if ret is None: raise libvirtError ('virDomainGetFSInfo() failed', dom=self)
        return ret
    ...
    def guestVcpus(self, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainGetGuestVcpus() failed', dom=self)
        return ret
    ...
    def migrateStartPostCopy(self, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainMigrateStartPostCopy() failed', dom=self)
        return ret
    ...
    def perfEvents(self, flags=0):
        ...
        if ret is None: raise libvirtError ('virDomainGetPerfEvents() failed', dom=self)
        return ret
    ...
    def pinIOThread(self, iothread_val, cpumap, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainPinIOThread() failed', dom=self)
        return ret
    ...
    def setPerfEvents(self, params, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainSetPerfEvents() failed', dom=self)
        return ret
    ...
    def setUserPassword(self, user, password, flags=0):
        ...
        if ret == -1: raise libvirtError ('virDomainSetUserPassword() failed', dom=self)
        return ret
    ...
    def vcpus(self):
        ...
        if ret is None: raise libvirtError ('virDomainGetVcpus() failed', dom=self)
        return ret
...
class virNetwork(object):
    ...
    def DHCPLeases(self, mac=None, flags=0):
        ...
        if ret is None: raise libvirtError ('virNetworkGetDHCPLeases() failed', net=self)
        return ret
...
class virConnect(object):
    ...
    def getDomainCapabilities(self, emulatorbin, arch, machine, virttype, flags=0):
...
VIR_DOMAIN_MEMORY_STAT_LAST = 10
